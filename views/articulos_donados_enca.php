...
$query = "SELECT * FROM articulos WHERE estatus= 'donado'";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  ?>
  <h4 class="text-light d-none d-lg-block">Bienvenido Administrador <?php echo $_SESSION['matricula']; ?></h4>
      ...
      <div class="collapse navbar-collapse" id="sidebarMenu">
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link text-light" href="lista_alumno_enca.php">Lista de Alumnos</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-light" href="rejilla_encargado.php">Lista de Articulos</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-light" href="historial_pedido_enca.php">HISTORIAL DE SOLICITUDES</a>
            </li>
          </ul>
        </div>
      </div>
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10">
    <article class="contenido-principal">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Lista de Artículos Donados</h1>
                    <a href='imprimir_articulos_donados.php' class='btn btn-primary' role='button'>Imprimir <i class='fas fa-print'></i></a>
                </div>
                    ...
                    <table id="tablaArticulosPerdidos" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='5'>No se encontraron artículos donados.</td></tr>";
                            }
                            $conn->close();
                            ?>
                        </tbody>
