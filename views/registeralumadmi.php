...
<div class="container mt-7">
        ...
        <form action="../register.php" method="POST">
            ...
            <br>
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#importModal"><i class='fas fa-file-csv'></i> IMPORTAR CSV</button>
                        ...
                        <div class="modal-body">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../csv/importar_registro_admi.php" method="post" enctype="multipart/form-data">
