...
class PDF extends FPDF {
    function Header() {
        ...
        $this->Cell(0, 6, utf8_decode('Lista de Artículos Dañados'), 0, 1, 'C');
...
$query = "SELECT id_articulo, nombre, categoria, descripcion, cantidad, fh, estado FROM articulos_dañados";
