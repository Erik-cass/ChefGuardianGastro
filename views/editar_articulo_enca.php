...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateQuery = "UPDATE articulos SET nombre='$nombre', cantidad='$cantidad', descripcion='$descripcion', imagen='$imagen' WHERE id_articulo='$id'";

    if ($conn->query($updateQuery) === TRUE) {
        header("Location: rejilla_encargado.php");
        exit();
    } else {
...
<div class="container mt-5">
    ...
    <center>
        ...
        <a href="rejilla_encargado.php" class="btn btn-secondary">Cancelar</a>
    </center> 
